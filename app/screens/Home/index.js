          ...
          {categories.map((item, index) => {
            return (
              <TouchableOpacity
                ...
                style={[
                  styles.serviceItem,
                  {width: (Utils.getWidthDevice() - 40) * 0.33333, marginBottom: 12,},
                ]}
                onPress={() => {
                ...
                <Text footnote numberOfLines={2} style={{textAlign: 'center', height: 36}} >
                  {t(item.title)}
                </Text>
              </TouchableOpacity>
            );
      ...
      <View style={styles.serviceContent}>
        {[1, 2, 3, 4, 5, 6].map((item, index) => {
          return (
            <View
              style={{
                width: (Utils.getWidthDevice() - 40) * 0.33333,
                marginBottom: 12,
              }}
              key={`category${item}`}>
